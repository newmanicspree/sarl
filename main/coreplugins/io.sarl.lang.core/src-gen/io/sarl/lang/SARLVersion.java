...
public final class SARLVersion {
	 ...
	 */
	public static final float SPECIFICATION_RELEASE_VERSION = (float) (0.8);
	 ...
	 * represent the version of the SARL specification and tools.
	 */
	public static final String SPECIFICATION_RELEASE_VERSION_STRING = "0.8"; //$NON-NLS-1$
	 ...
	 */
	public static final String SARL_RELEASE_VERSION = "0.8.4"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_MAVEN
	 */
	public static final String SARL_RELEASE_VERSION_OSGI = "0.8.4"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_OSGI
	 */
	public static final String SARL_RELEASE_VERSION_MAVEN = "0.8.4"; //$NON-NLS-1$
