...
public final class SARLVersion {
	 ...
	 */
	public static final String SARL_RELEASE_VERSION = "0.8.2"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_MAVEN
	 */
	public static final String SARL_RELEASE_VERSION_OSGI = "0.8.2"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_OSGI
	 */
	public static final String SARL_RELEASE_VERSION_MAVEN = "0.8.2"; //$NON-NLS-1$
