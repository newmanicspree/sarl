...
public class SARLValidator extends AbstractSARLValidator {
	...
	public void checkClassPath(XtendFile sarlScript) {
		...
		final LibraryErrorCode errorCode = Utils.getSARLLibraryVersionOnClasspath(typeReferences, sarlScript, sarlLibraryVersion);
		if (errorCode != LibraryErrorCode.LIBRARY_FOUND) {
