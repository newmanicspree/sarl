...
/** Class that implements the standard main function for running a SARL shell
 ...
 * @since 0.10
 */
public class BootiqueSarlShell {
	...
	/** Run the shell.
	 *
	 * <p>This function runs the shell and exits with the return code.
	 *
	 * @param args the command line arguments.
